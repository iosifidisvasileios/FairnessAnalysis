...
//    public static int sa_Index=20,dc=1,ndc=0;
    // ************************************************************

    // ****************** ADULT CENSUS *******************
    // SA is gender
    public static String sa, sa_Deprived="' Female'",sa_Favored="' Male'";
    public static int sa_Index=9,dc=1,ndc=0;

    // SA is ethnicity
//    public static String sa, sa_Deprived="' Minorities'",sa_Favored="' White'";
//    public static int sa_Index=8,dc=1,ndc=0;
    // ************************************************************

    // *************************DUTCH DATASET **************************
    // SA is gender
//    public static String sa, sa_Deprived="2",sa_Favored="1";
//    public static int sa_Index=0,dc=1,ndc=0;
    // ************************************************************

    // *********************** Synthetic Generator **********************
    // SA is defined inside class. set the same indexes
//    public static String sa, sa_Deprived="Female",sa_Favored="Male";
//    public static int sa_Index=5,dc=1,ndc=0;
// ************************************************************
 ...
 */
  public static double getDisc(Instances test) {
