...
// * @author fkamiran
// */
//public class LocalMsgFilter extends Filter{  //implements OptionHandler
//  /**
...
//               // Pos or negeative class ratio from Eq 6 of paper is calculated as
//               //(((f/n)*(biasStat[i][0][0]/fLocal))+((m/n)*(biasStat[i][1][0]/mLocal)));
...
// 	Filter.batchFilterFile(new LocalMsgFilter(), argv);
//      } else {
//	Filter.filterFile(new LocalMsgFilter(), argv);
//      }
//    } catch (Exception ex) {
//		ex.printStackTrace();
